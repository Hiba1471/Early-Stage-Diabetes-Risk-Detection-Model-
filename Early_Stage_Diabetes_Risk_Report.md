...
I calculated Youden's J index, $J = Sensitivity + Specificity - 1$, across the ROC curve. This is a common healthcare evaluation approach and helped identify the optimal threshold for each model by balancing Recall and Specificity.
